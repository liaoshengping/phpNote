                                ...
                                <?php $__currentLoopData = $menus; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php if(!empty($item['sub'])): ?>
                                        <li class="has-children">
                                            <a href="#"><?php echo e($item['name']); ?> <i class="fa fa-angle-down"></i></a>
                                            <ul class="sub-menu">
                                                ...
                                                <?php $__currentLoopData = $item['sub']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sub_item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li><a href="<?php echo e($sub_item['href']); ?>"><?php echo e($sub_item['name']); ?></a></li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
                                        </li>
                                    <?php else: ?>
                                        <li><a href="<?php echo e($item['href']); ?>"><?php echo e($item['name']); ?></a></li>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="row mb-n8">
                ...
                <div class="col-12 col-sm-6 col-lg-2 mb-8">
                    <div class="single-footer-widget aos-init aos-animate">
                        ...
                        <div class="widget-slogan bg-white">
                            <?php echo e(config('slogan')); ?>

                        </div>
                    </div>
                </div>

                <?php $__currentLoopData = config('footer_urls'); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $items): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="col-12 col-sm-6 col-lg-2 mb-8">
                        <div class="single-footer-widget aos-init aos-animate">
                            <h2 class="widget-title"><?php echo e($items['name']); ?></h2>
                ...
                <div class="col-12 col-sm-6 col-lg-2 mb-8">
                    <div class="single-footer-widget aos-init aos-animate d-flex flex-column align-items-center">
                        ...
                        <div>
                            <img src="<?php echo e(config('qrCode')); ?>">
                        </div>
                        <div>扫码关注微信公众号</div>
                    </div>
                </div>
...
<!-- Mobile Menu End --><?php /**PATH E:\linuxdir\php\phpNote\build\container\functions\htmlv1\bootstrap_official\html/layout.blade.php ENDPATH**/ ?>