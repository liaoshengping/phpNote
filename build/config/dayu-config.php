...
return [
    "frame" => LARAVEL,
    'frame_path' => xenv("dayu_path",FRAME_PATH),
    'frame_controller_path' => xenv("dayu_path",FRAME_PATH) . "app\Http\Controllers/",
    'frame_modebase_path' => xenv("dayu_path",FRAME_PATH) . 'app\Models\base\\',
    'frame_mode_path' => xenv("dayu_path",FRAME_PATH) . "app\Models/",
