...
return [
    "frame" => LARAVEL,
    'frame_path' => xenv("loveapi_path",FRAME_PATH),
    'frame_controller_path' => xenv("loveapi_path",FRAME_PATH) . "app\Http\Controllers/",
    'frame_modebase_path' => xenv("loveapi_path",FRAME_PATH) . 'app\Models\base\\',
    'frame_mode_path' => xenv("loveapi_path",FRAME_PATH) . "app\Models/",
...
//    'frame_path' => xenv("loveapi_path",FRAME_PATH),
//    'frame_controller_path' => xenv("loveapi_path",FRAME_PATH) . "app\Http\Controllers/",
//    'frame_modebase_path' => xenv("loveapi_path",FRAME_PATH) . 'app\Models\base\\'.MODEL.'\\',
//    'frame_mode_path' => xenv("loveapi_path",FRAME_PATH) . "app\Models/".MODEL.'/',
