...
return [
    "frame" => LARAVEL,
    'frame_path' => xenv("cid_path",FRAME_PATH),
    'frame_controller_path' => xenv("cid_path",FRAME_PATH) . "app\Http\Controllers/",
    'frame_modebase_path' => xenv("cid_path",FRAME_PATH) . 'app\Models\base\\',
    'frame_mode_path' => xenv("cid_path",FRAME_PATH) . "app\Models/",
