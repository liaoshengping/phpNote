...
return [
    "frame" => LARAVEL,
    'frame_path' => xenv("octopus_path",FRAME_PATH),
    'frame_controller_path' => xenv("octopus_path",FRAME_PATH) . "app\Http\Controllers/Api/",
    'frame_modebase_path' => xenv("octopus_path",FRAME_PATH) . 'app\Models\base\\',
    'frame_mode_path' => xenv("octopus_path",FRAME_PATH) . "app\Models/",
    ...
    'prefix' => "",
    'auto_build_time' => [ //目前不明确需要自动补充创建和更新时间
//        'created_at',
//        'updated_at',
//        'deleted_at'
