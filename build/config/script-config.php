...
return [
    "frame"                           => LARAVEL,
    'frame_path'                      => xenv("script_path", FRAME_PATH),
    'frame_controller_path'           => xenv("script_path", FRAME_PATH) . "app" . DIRECTORY_SEPARATOR . "Http" . DIRECTORY_SEPARATOR . "Controllers" . DIRECTORY_SEPARATOR,
    'frame_modebase_path'             => xenv("script_path", FRAME_PATH) . 'app' . DIRECTORY_SEPARATOR . 'Models' . DIRECTORY_SEPARATOR . 'base' . DIRECTORY_SEPARATOR,
    'frame_mode_path'                 => xenv("script_path", FRAME_PATH) . "app" . DIRECTORY_SEPARATOR . "Models" . DIRECTORY_SEPARATOR,
...
//    "frame" => LARAVEL,
//    'frame_path' => xenv("script_path",FRAME_PATH),
//    'frame_controller_path' => xenv("script_path",FRAME_PATH) . "app\Http\Controllers/",
//    'frame_modebase_path' => xenv("script_path",FRAME_PATH) . 'app\Models\base\\'.MODEL.'\\',
//    'frame_mode_path' => xenv("script_path",FRAME_PATH) . "app\Models/".MODEL.'/',
...
//    'disable_soft_delete' => true, //是否软删除
    ...
    "host" => xenv('host'),
//    "database" => 'mb_goods',
    "database" => xenv('database', 'pc_script'),
    "port" => xenv("port", "3306"),
